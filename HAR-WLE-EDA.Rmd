...
heatmap(m, scale="column", margins=c(10,1), cexCol=1, RowSideColors=rowColors, ColSideColors=colColors, col=dataColors, labRow=NA, main)
```
...
```{r totalPairs, echo=FALSE, fig.height=9, fig.width=9, cache=TRUE}
